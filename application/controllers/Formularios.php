...
class Formularios extends Base_Controller
{
    ...
    public function pre_calificacion()
    {
        ...
        if ($this->input->post('correo')) {
            ...
            //mensaje
            $message = '<html><body>';
            $message .= '<img src="http://gpautos.net/ui/public/images/logoGp.png" alt="GP AUT OS" />';
            $message .= '<table>';
    ...
    public function biennvenida_tpl()
    {
        $data['id'] = '1';
    ...
    public function franquicias(){
        ...
        echo $this->templates->render('public/public_franquicias', $data);
    }
    public function guardar_formulario_franquicias(){

       //obtemos las variables del post
        $nombre = $this->input->post('nombre');
        $correo = $this->input->post('correo');
        $telefono = $this->input->post('telefono');
        $ocupacion = $this->input->post('ocupacion');
        //asignamos variablea a arreglo
        ...
        //guardamos los datos del formulario en base de datos

        $this->Formularios_model->guardar_solicitud_franquicia($datos_solicitud);
        // enviamos correo de notifiacion
        ...
        $this->email->subject('Solicitud de franquicia');
        ...
        $message .= "<tr><td><strong>Email:</strong> </td><td>" . strip_tags($correo) . "</td></tr>";
        $message .= "<tr><td><strong>Telefono:</strong> </td><td>" . $telefono . "</td></tr>";
        $message .= "<tr><td><strong>Ocupacion:</strong> </td><td>" . $ocupacion . "</td></tr>";
        $message .= "</table>";
        $message .= "</body></html>";
        $this->email->message($message);
        //enviar correo
        $this->email->send();
        // solicitud enviada
        $this->session->set_flashdata('mensaje', 'Su solicitud se envió correctamente');
        redirect(base_url().'formularios/franquicias');
